...
/**
 * ---------------------------------------------------------------------------------------------------------------------
 * Default configuration for containers extending Runtime\Container\ProcessContainer.
 *
...
return [
     ...
     * to be used in this container's children by using %context.variableName% notation.
     * -----------------------------------------------------------------------------------------------------------------
     */
    'context' => [
